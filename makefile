...
all: $(TARGET1) $(TARGET2) $(TARGET3) $(TARGET4) $(TARGET5) $(DUPSPLIT) $(REAL) $(DUPSPLIT_SITE_PERCOLATION)
...
clean:
	$(RM) $(TARGET1) $(TARGET2) $(TARGET3) $(TARGET4) $(TARGET5) $(DUPSPLIT) $(REAL) $(DUPSPLIT_SITE_PERCOLATION)
